...
type SubcategoryRepositoryInterface interface {
	Create(ctx context.Context, tx pgx.Tx, data *dto.CreateSubcategoryDTO) (*dto.SubcategoryDTO, error)
	GetByID(ctx context.Context, tx pgx.Tx, id int) (*dto.SubcategoryDTO, error)
	GetAll(ctx context.Context, tx pgx.Tx) ([]*dto.SubcategoryDTO, error)
	Update(ctx context.Context, tx pgx.Tx, id int, data *dto.UpdateSubcategoryDTO) (*dto.SubcategoryDTO, error)
...
func (r *SubcategoryRepository) Create(ctx context.Context, tx pgx.Tx, data *dto.CreateSubcategoryDTO) (*dto.SubcategoryDTO, error) {
...
func (r *SubcategoryRepository) GetByID(ctx context.Context, tx pgx.Tx, id int) (*dto.SubcategoryDTO, error) {
	query := `SELECT subcategory_id, name, category_id FROM subcategory WHERE subcategory_id = $1`
	var subcategory dto.SubcategoryDTO
	err := tx.QueryRow(ctx, query, id).Scan(&subcategory.SubcategoryID, &subcategory.Name, &subcategory.CategoryID)
	if err != nil {
		return nil, err
	}
	return &subcategory, nil
...
func (r *SubcategoryRepository) GetAll(ctx context.Context, tx pgx.Tx) ([]*dto.SubcategoryDTO, error) {
...
func (r *SubcategoryRepository) Update(ctx context.Context, tx pgx.Tx, id int, data *dto.UpdateSubcategoryDTO) (*dto.SubcategoryDTO, error) {
...
func (r *SubcategoryRepository) Delete(ctx context.Context, tx pgx.Tx, id int) error {
